...
class PersonaModel
{
    ...
    {
        return $this->db
            ->query("SELECT * FROM Persona ORDER BY id_bombero ASC")
            ->fetchAll();
    }
     ...
     */
    public function find($id_bombero): ?array
    {
        $result = $this->db
     ...
     */
    public function update($id_bombero, array $data): int
    {
        $this->db->query("
            UPDATE Persona SET
     ...
     * Eliminar persona
     */
    public function delete($id_bombero): int
    {
        $this->db
