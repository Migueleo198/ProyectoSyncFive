...
class AlmacenService
{
    ...
    {
        try {
            if (!$this->model->almacenPerteneceAInstalacion($id_almacen, $id_instalacion)) {
     ...
     */
    public function deleteMaterialFromAlmacen(int $id_almacen, int $id_instalacion, int $id_material): void
    {
        try {
            if (!$this->model->almacenPerteneceAInstalacion($id_almacen, $id_instalacion)) {
