...
class AlmacenController
{
    ...
    // GET /instalaciones/{id_instalacion}/almacenes/{id_almacen}
    public function show(Request $req, Response $res, string $id_instalacion, string $id_almacen): void
    {
        try {
            $almacen = $this->service->getAlmacenById((int) $id_almacen, (int) $id_instalacion);
    ...
    // Query opcional para materiales por serie: ?n_serie=...
    public function deleteMaterial(Request $req, Response $res, string $id_instalacion, string $id_almacen, string $id_material): void
    {
        try {
            ...
            $nSerie = $queryParams['n_serie'] ?? null;
            $this->service->deleteMaterialFromAlmacen((int) $id_almacen, (int) $id_instalacion, (int) $id_material, $nSerie !== null ? (string) $nSerie : null);
