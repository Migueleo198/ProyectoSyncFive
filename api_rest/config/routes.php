...
// ROL PERSONA
$router->protectedSession('GET', '/personas/{n_funcionario}/roles', 'Controllers\\RolController@persons', [4,5]);
$router->protectedSession('POST', '/personas/{n_funcionario}/roles/{ID_Rol}', 'Controllers\\RolController@assign', [5]);
